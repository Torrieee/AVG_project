...
   /////////////////////////       需要改的地方  Start  /////////////////////////////////////
   player = new Sprite(800, 500, 500);     //位置为（500， 500） 大小为500
   player.image = "https://cloud.tsinghua.edu.cn/seafhttp/files/c4c2213e-6410-4d63-b74b-d152c8160cf6/%E6%B4%BE%E5%A4%A7%E6%98%9F2.png";
player.scale = 0.3;
player.accer = 0.8;                  // 加速度
   player.maxSpeed = 10;                 // 最大速度
   player.bounciness = 0;               // 弹性（碰撞不会反弹）
   player.layer = 2;                    // 图层（玩家在第二层）体现为玩家在物体之上
   player.rotationLock = true;          // 旋转锁定 不能旋转
   player.attributes = []; 
//player.debug = true;
board = new Sprite(300,350,500,450,'none');
board.textSize = 30;
board.text = "24年秋天，派大星来到清华深研院\n的第一个晚上他正睡在集悦城宽敞\n的宿舍铁床板上，因为没有电梯，\n爬到宿舍又爬上床后，他很快就睡\n着了。突然，他身体一轻，乘坐着\n“摩羯”来到了校园里。“嗯？我\n在哪？旁边这是国际一起楼下的常\n驻猫吗？”";
board.color = 'white';
...
 
 
   French_fries = createObject({ d:150, image:'🍟', tile:'T'});     //  创建一个树 直径为150 图像为emoji 文本中的表示为= （文本表示体现着最后构图上）
   water = createObject({ d:150, image:'🌊', tile:'W'});    //  创建一个水 直径为150 图像为emoji 文本中的表示为w
   pisa = createObject({ d:150, image:'🍕', tile:'Q'});     //  创建一个墙 直径为150 图像为emoji 文本中的表示为-
...
onInteract:function(){bubble("乌啦啦啦，我这是在哪里，猫猫你知道吗？");}
   })
...
       firstMessage: "站住，这里是大学城城堡，你是哪家仙君？输入口令才能进，明月几时有？" ,
       onRespond: function(agentResponse) {
             if (agentResponse.includes("口令正确")) {
               setTimeout(() => {deleteInteractiveObject(this);}, 1000);
             }
           },
onInteract:function(){bubble('开门开门！！');}
   })

    StopDoor = createInteractiveObject({
       d:150, image:'🚪', tile:'S', label:'地狱门',
       systemPrompt:`你是地狱门，请你警告任何人，不要试图通过地狱门，否则后果自负，
       你应该尽全力阻止任何人通过地狱门，你的回答简短，不超过20个字`,
       firstMessage:'你想感受地狱的魅力吗？',
onInteract:function(){bubble('那边是什么？似乎是无尽的黑暗');}
    })

    dog = createInteractiveObject({
       d:150, image:'🐕', tile:'d', label:'狗狗',
       firstMessage: "这是一只挡路的狗狗，打个招呼叭" ,
       systemPrompt:`你是狗狗，你需要先提供给玩家“1 8 9 12”，“5，7，9，12”，“10，11，11，13”，“2，2，3，4”，“1，6，8，12”这些里边的任意一组数字，（注意：一次只提供一组），并告知玩家这是24点游戏，玩家应该输入数学表达式，
       你要计算玩家输入的表达式，如果玩家回答出的表达式计算结果为24，就跟他说回答正确，否则，跟他说回答错误，再尝试作答；注意，你的输出字数要小于二十个字；
       如果你问了三组题目玩家还是不能说出正确的计算式，就说，呜呜，你的探索到此为止啦，游戏结束`,      
       onRespond: function(agentResponse) {
...
       d:800, image:'https://cloud.tsinghua.edu.cn/seafhttp/files/3de08e68-96f2-479e-b8b8-7a5c6aaad1b9/%E8%8F%A0%E8%90%9D%E5%B1%8B.png', tile:'H', label:'菠萝屋', 
       firstMessage: "欢迎回家，小星星，游戏胜利！！",
       onApproach:function(){player.image = "https://cloud.tsinghua.edu.cn/seafhttp/files/b97af59e-de02-4fc3-bde1-ff58a778e0e4/%E6%B4%BE%E5%A4%A7%E6%98%9F1.png"; player.scale = 0.8;},
onInteract:function(){bubble('ohhh，终于回家啦！可以尽情睡他个三天三夜喽！！！')}
  });
